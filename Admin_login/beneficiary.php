...
<body>
<form onSubmit="confirmInput()" action="index.php">
...
function myFunction() {  var txt;  var r = confirm("Are you sure you want to continue? Please make sure that all the information you entered are valid and correct otherwise may lead to disqualification of your application.");  
...
; }
 ...
 else {   alert ("If you are not sure, please review your application one more time."); }
...
function confirmInput() {
 ...
 alert('You will now be redirected to the second part');

 
 }
 </script>​
    <TR>    
	  <TD> <p>      </TD> <TD><input name="submit" onclick="myFunction()"   type="submit" value="Submit" /></a></p></TD> 
	</TR>
